...
> **Note:** For **1CH** demo workflows, one confirmed site binding is enough. For **8CH** workflows, bind every active channel to its actual site before relying on multichannel monitoring or analysis.
...
→ [Choose between the 1CH and 8CH hardware paths](/docs/hardware/choose-your-module)  
