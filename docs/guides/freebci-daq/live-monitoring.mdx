...
Scalp topography showing band power intensity at electrode positions. Switch the heat metric between Delta/Theta/Alpha/Beta/Gamma/EI.

- In **1CH** workflows, treat it as a simplified single-site demo view
- In **8CH** workflows, bind every acquisition channel to its electrode site for a fuller spatial setup
