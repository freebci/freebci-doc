...
![波形面板](screenshots/panel-waveforms-en.png)
...
![频谱对比](screenshots/panel-spectrum-en.png)

0–30 Hz FFT 幅度柱状图。按 **📸 快照** 固定当前频谱为虚线参考。用于对比基线状态与任务状态。

## 脑区热力图

![脑区热力图](screenshots/panel-heatmap-en.png)
...
![五频段特征趋势](screenshots/panel-fiveband-en.png)
